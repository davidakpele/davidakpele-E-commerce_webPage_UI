		...
		<div class="ps-container">
			<div class="ps-section__left">
				<div class="ps-carousel--nav-inside owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on">
					...
					<div class='ps-banner'>
						<a title='Images Slider Produk 2' href='https://tajalapak.com/auth/login'><img src='img/slide-2.jpg' alt='slide-2.jpg'></a>
					</div>
					<div class='ps-banner'>
						<a title='Images Slider Produk 3' href='https://tajalapak.com/auth/login'><img src='img/slide-3.jpg' alt='slide-3.jpg'></a>
					</div>
				</div>
			</div>
		...
		<div class="ps-container">
			<div class="ps-section__header">
				...
				<ul class='ps-section__links'>
					<li>
						<a href='https://tajalapak.com/produk/kategori/perhiasan-dan-aksesoris'>Lihat Semua</a>
					</li>
				</ul>
			</div>
			<div class="ps-section__content">
					...
					<div class='ps-product'>
						<div class='ps-product__thumbnail'>
							...
							<ul class='ps-product__actions produk-5'>
								<li>
									<a href='https://tajalapak.com/produk/detail/segitiga-instan-madeira--mdb52-ocean-122317' data-toggle='tooltip' data-placement='top' title='Read More'><i class='icon-bag2'></i></a>
								</li>
								<li>
